export default function LinkedInIcon({
  ...
  const colors = {
    text: textColor === "green" ? "#B9FF66" : "black",
    bg: bgColor === "black" ? "black" : "white",
  };
  ...
  return (
    <svg
      ...
      className={className}
    >
      <circle cx="17" cy="17" r="17" fill={colors.bg} />
      <path d="M9.31776 25H12.8131V13.6844H9.31776V25Z" fill={colors.text} />
      <path
